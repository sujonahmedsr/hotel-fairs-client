            ...
            <section className="bg-white dark:bg-gray-900 ">
                <div className="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:flex-row-reverse flex-col-reverse lg:gap-12">
                    <div className="wf-ull lg:w-1/2">
                        <p className="text-sm font-medium text-primay dark:text-primay">404 error</p>
                        ...
                        <div className="flex items-center mt-6 gap-x-3">
                            ...
                            <Link to={'/'} className=" px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-primay rounded-lg shrink-0 sm:w-auto hover:bg-cyan-600 dark:hover:bg-primay dark:bg-primay">
                                <button >
                                    Take me home
                                </button>
                            </Link>

...
const OfferModal = ({handleModal}) => {
    return (
        <div className="fixed inset-0 pt-10  md:pt-24 px-3 z-10 w-full bg-gray-500 bg-opacity-45">
            <div className="max-w-3xl mx-auto p-5 md:p-10 shadow-xl border relative bg-white space-y-2">
                ...
                <h1 className="text-lg font-bold border p-2">Free Swimming In your holidays</h1>
                <div>
